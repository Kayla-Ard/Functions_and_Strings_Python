...
# and overrides the default parameter
...
def add_numbers(a,b):
    return a + b
# saves the output of our function to variable
...
# using the result of another function in a function call
...
# print(evens_list) #cant access variable scoped to a function
